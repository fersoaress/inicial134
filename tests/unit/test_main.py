...
@pytest.mark.parametrize('numero_a,numero_b,resultado_esperado', ler_csv('/home/fernanda/PycharmProjects/inicial134/vendors/csv/massa_teste_subtrair_positivo.csv'))
def testar_subtrair_leitura_csv(numero_a, numero_b, resultado_esperado):
    # 1 - Configura
    # 1.2 - Resultado esperado
    # 2 - Executa
